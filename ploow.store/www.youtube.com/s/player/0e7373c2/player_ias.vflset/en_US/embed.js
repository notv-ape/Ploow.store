(function(g) {
    ...
    var J0a = function(a, b) {
        ...
        R5 = function(a) {
            ...
            this.previous.Ma("click", this.CT, this);
            g.M(this, this.N);
            for (var c = {
                    wt: 0
                }; 16 > c.wt; c = {
            ...
            this.next.Ma("click", this.BT, this);
        ...
        Z5 = function(a, b) {
            ...
            g.M(this, this.previous);
            this.previous.xa(this.element);
            this.previous.Ma("click", this.ET, this);
            g.M(this, this.N);
            for (a = {
                    xt: 0
                }; 16 > a.xt; a = {
            ...
            g.M(this, this.next);
            this.next.xa(this.element);
            this.next.Ma("click", this.DT, this);
            b = new g.X({
                F: "button",
            ...
            g.M(this, b);
            b.xa(this.element);
            b.Ma("click", this.a_, this);
            g.M(this, this.expandButton);
            this.expandButton.xa(this.element);
            this.expandButton.Ma("click", this.b_, this);
    ...
    X5.prototype.u = function() {
        ...
        this.api.R().K("embeds_enable_muted_autoplay") && b.mutedAutoplay && (g.W(a, 2) && !this.rb ? (this.show(), this.j.show(), a = this.api.getVideoData(), this.Ja("text", a.pM), g.N(this.element, "ytp-muted-autoplay-show-end-panel", !0), this.api.Xa(this.element, this.rb), this.api.La("onMutedAutoplayEnds")) : this.hide())
    };
    ...
    g.k.create = function() {
        ...
        this.j.P(this.G, "videodatachange", this.d4);
