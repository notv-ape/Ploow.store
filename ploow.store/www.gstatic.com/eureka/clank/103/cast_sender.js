(function() {
    ...
    */
    ...
    chrome.cast.Fc = !0;
    x("chrome.cast.usingPresentationApi", chrome.cast.Fc);
    chrome.cast.ab = function(a, b) {
        this.credentials = a;
        this.credentialsType = void 0 === b ? "web" : b
    };
    x("chrome.cast.CredentialsData", chrome.cast.ab);
    ...
    chrome.cast.Db = function(a) {
        this.platform = a;
        this.packageId = this.url = null
    };
    x("chrome.cast.SenderApplication", chrome.cast.Db);
    ...
    x("chrome.cast.AutoJoinPolicy", chrome.cast.ia);
    chrome.cast.la = {
        CREATE_SESSION: "create_session",
        CAST_THIS_TAB: "cast_this_tab"
    };
    x("chrome.cast.DefaultActionPolicy", chrome.cast.la);
    chrome.cast.$a = {
        VIDEO_OUT: "video_out",
        AUDIO_OUT: "audio_out",
        VIDEO_IN: "video_in",
    ...
    x("chrome.cast.Capability", chrome.cast.$a);
    chrome.cast.C = {
        CANCEL: "cancel",
        TIMEOUT: "timeout",
    ...
    x("chrome.cast.SenderPlatform", chrome.cast.Eb);
    chrome.cast.za = {
        CAST: "cast",
        DIAL: "dial",
        HANGOUT: "hangout",
    ...
    x("chrome.cast.ReceiverType", chrome.cast.za);
    chrome.cast.cb = {
        RUNNING: "running",
        STOPPED: "stopped",
        ERROR: "error"
    };
    x("chrome.cast.DialAppState", chrome.cast.cb);
    chrome.cast.zb = {
        CAST: "cast",
        STOP: "stop"
    };
    x("chrome.cast.ReceiverAction", chrome.cast.zb);
    chrome.cast.L = {
        CONNECTED: "connected",
    ...
    x("chrome.cast.VolumeControlType", chrome.cast.Sb);
    ...
    var Ia = function(a) {
        ...
        Ha = /&([^;\s<&]+);?/g;
    chrome.cast.Wa = function(a, b, c, d, e) {
        this.sessionRequest = a;
        this.sessionListener = b;
        this.receiverListener = c;
        this.autoJoinPolicy = d || chrome.cast.ia.TAB_AND_ORIGIN_SCOPED;
        this.defaultActionPolicy = e || chrome.cast.la.CREATE_SESSION;
        this.customDialLaunchCallback = null;
        this.invisibleSender = !1;
        this.additionalSessionRequests = []
    };
    x("chrome.cast.ApiConfig", chrome.cast.Wa);
    chrome.cast.gb = function(a, b) {
        this.appName = a;
        this.launchParameter = b || null
    };
    x("chrome.cast.DialRequest", chrome.cast.gb);
    chrome.cast.eb = function(a, b, c) {
        this.receiver = a;
        this.appState = b;
        this.extraData = c || null
    };
    x("chrome.cast.DialLaunchData", chrome.cast.eb);
    chrome.cast.fb = function(a, b) {
        this.doLaunch = a;
        this.launchParameter = b || null
    };
    x("chrome.cast.DialLaunchResponse", chrome.cast.fb);
    chrome.cast.Fb = function(a, b, c, d, e) {
    ...
    x("chrome.cast.SessionRequest", chrome.cast.Fb);
    chrome.cast.yb = function(a, b, c, d) {
        this.label = a;
        a = b;
        ...
        this.capabilities = c || [];
        this.volume = d || null;
        this.receiverType = chrome.cast.za.CAST;
        this.displayStatus = this.isActiveInput = null
    };
    x("chrome.cast.Receiver", chrome.cast.yb);
    chrome.cast.Ab = function(a, b) {
        this.statusText = a;
        this.appImages = b;
        this.showStop = null
    };
    x("chrome.cast.ReceiverDisplayStatus", chrome.cast.Ab);
    chrome.cast.Ca = function() {
    ...
    x("chrome.cast.Timeout", chrome.cast.Ca);
    chrome.cast.timeout = new chrome.cast.Ca;
    x("chrome.cast.timeout", chrome.cast.timeout);
    chrome.cast.Va = "auto-join";
    chrome.cast.sb = "cast-session_";
    chrome.cast.media.lb = {
        SDR: "sdr",
        HDR: "hdr",
        DV: "dv"
    };
    x("chrome.cast.media.HdrType", chrome.cast.media.lb);
    ...
    x("chrome.cast.media.HlsSegmentFormat", chrome.cast.media.mb);
    chrome.cast.media.nb = {
        MPEG2_TS: "mpeg2_ts",
        FMP4: "fmp4"
    };
    x("chrome.cast.media.HlsVideoSegmentFormat", chrome.cast.media.nb);
    ...
    x("chrome.cast.media.MediaCommand", chrome.cast.media.qb);
    ...
    x("chrome.cast.media.QueueType", chrome.cast.media.wb);
    chrome.cast.media.W = {
        GENERIC_CONTAINER: 0,
    ...
    x("chrome.cast.media.ResumeState", chrome.cast.media.Bb);
    chrome.cast.media.Ba = {
        BUFFERED: "BUFFERED",
        LIVE: "LIVE",
        OTHER: "OTHER"
    };
    x("chrome.cast.media.StreamType", chrome.cast.media.Ba);
    ...
    x("chrome.cast.media.IdleReason", chrome.cast.media.ob);
    chrome.cast.media.Nb = {
        TEXT: "TEXT",
        AUDIO: "AUDIO",
        VIDEO: "VIDEO"
    };
    x("chrome.cast.media.TrackType", chrome.cast.media.Nb);
    ...
    x("chrome.cast.media.TextTrackType", chrome.cast.media.Kb);
    ...
    x("chrome.cast.media.TextTrackEdgeType", chrome.cast.media.Gb);
    chrome.cast.media.Lb = {
        NONE: "NONE",
        NORMAL: "NORMAL",
        ROUNDED_CORNERS: "ROUNDED_CORNERS"
    };
    x("chrome.cast.media.TextTrackWindowType", chrome.cast.media.Lb);
    ...
    x("chrome.cast.media.TextTrackFontGenericFamily", chrome.cast.media.Hb);
    ...
    x("chrome.cast.media.TextTrackFontStyle", chrome.cast.media.Ib);
    chrome.cast.media.Ob = {
        LIKE: "LIKE",
        DISLIKE: "DISLIKE",
        FOLLOW: "FOLLOW",
    ...
    x("chrome.cast.media.UserAction", chrome.cast.media.Ob);
    chrome.cast.media.na = function() {
        this.customData = null
    };
    x("chrome.cast.media.GetStatusRequest", chrome.cast.media.na);
    chrome.cast.media.ra = function() {
        this.customData = null
    };
    x("chrome.cast.media.PauseRequest", chrome.cast.media.ra);
    chrome.cast.media.ta = function() {
        this.customData = null
    };
    x("chrome.cast.media.PlayRequest", chrome.cast.media.ta);
    chrome.cast.media.Cb = function() {
        this.customData = this.resumeState = this.currentTime = null
    };
    x("chrome.cast.media.SeekRequest", chrome.cast.media.Cb);
    chrome.cast.media.Aa = function() {
        this.customData = null
    };
    x("chrome.cast.media.StopRequest", chrome.cast.media.Aa);
    chrome.cast.media.Tb = function(a) {
        this.volume = a;
        this.customData = null
    };
    x("chrome.cast.media.VolumeRequest", chrome.cast.media.Tb);
    chrome.cast.media.pb = function(a) {
        this.type = "LOAD";
        this.requestId = 0;
        this.sessionId = null;
        this.media = a;
    ...
    x("chrome.cast.media.LoadRequest", chrome.cast.media.pb);
    chrome.cast.media.tb = function(a) {
        this.type = "PRECACHE";
        this.requestId = 0;
        this.precacheData = a
    };
    chrome.cast.media.hb = function(a, b) {
        this.requestId = 0;
        this.activeTrackIds = a || null;
        this.textTrackStyle = b || null
    };
    x("chrome.cast.media.EditTracksInfoRequest", chrome.cast.media.hb);
    ...
    x("chrome.cast.media.GenericMediaMetadata", chrome.cast.media.ma);
    ...
    x("chrome.cast.media.MovieMediaMetadata", chrome.cast.media.pa);
    ...
    q(chrome.cast.media.Da, chrome.cast.media.MediaMetadata);
    x("chrome.cast.media.TvShowMediaMetadata", chrome.cast.media.Da);
    ...
    x("chrome.cast.media.MusicTrackMediaMetadata", chrome.cast.media.qa);
    ...
    x("chrome.cast.media.PhotoMediaMetadata", chrome.cast.media.sa);
    ...
    q(chrome.cast.media.ha, chrome.cast.media.V);
    x("chrome.cast.media.AudiobookContainerMetadata", chrome.cast.media.ha);
    ...
    q(chrome.cast.media.ga, chrome.cast.media.MediaMetadata);
    x("chrome.cast.media.AudiobookChapterMediaMetadata", chrome.cast.media.ga);
    chrome.cast.media.rb = function(a, b) {
        this.contentId = a;
        this.contentUrl = void 0;
        this.streamType = chrome.cast.media.Ba.BUFFERED;
        this.contentType = b;
        this.metadata = null;
    ...
    x("chrome.cast.media.MediaInfo", chrome.cast.media.rb);
    ...
    x("chrome.cast.media.QueueItem", chrome.cast.media.va);
    chrome.cast.media.bb = "CC1AD845";
    x("chrome.cast.media.DEFAULT_MEDIA_RECEIVER_APP_ID", chrome.cast.media.bb);
    ...
    x("chrome.cast.media.Track", chrome.cast.media.Mb);
    ...
    x("chrome.cast.media.TextTrackStyle", chrome.cast.media.Jb);
    ...
    x("chrome.cast.media.QueueLoadRequest", chrome.cast.media.vb);
    ...
    x("chrome.cast.media.QueueInsertItemsRequest", chrome.cast.media.ua);
    ...
    x("chrome.cast.media.QueueUpdateItemsRequest", chrome.cast.media.xb);
    ...
    x("chrome.cast.media.QueueSetPropertiesRequest", chrome.cast.media.ya);
    ...
    x("chrome.cast.media.QueueRemoveItemsRequest", chrome.cast.media.wa);
    ...
    x("chrome.cast.media.QueueReorderItemsRequest", chrome.cast.media.xa);
    ...
    x("chrome.cast.media.Break", chrome.cast.media.Xa);
    ...
    x("chrome.cast.media.BreakClip", chrome.cast.media.Ya);
    chrome.cast.media.Qb = function() {
        this.adsResponse = this.adTagUrl = void 0
    };
    x("chrome.cast.media.VastAdsRequest", chrome.cast.media.Qb);
    ...
    x("chrome.cast.media.BreakStatus", chrome.cast.media.Za);
    chrome.cast.media.oa = function(a, b, c, d) {
        this.start = a;
        this.end = b;
        this.isMovingWindow = c;
        this.isLiveDone = d
    };
    x("chrome.cast.media.LiveSeekableRange", chrome.cast.media.oa);
    chrome.cast.media.ub = function(a, b, c, d, e, h, k) {
        this.id = a;
    ...
    x("chrome.cast.media.QueueData", chrome.cast.media.ub);
    chrome.cast.media.Pb = function(a) {
        this.userAction = a;
        this.customData = void 0
    };
    x("chrome.cast.media.UserActionState", chrome.cast.media.Pb);
    chrome.cast.media.Rb = function(a, b, c) {
        this.width = a;
        this.height = b;
        this.hdrType = c
    };
    x("chrome.cast.media.VideoInformation", chrome.cast.media.Rb);
    ...
    f.ic = function(a, b, c) {
        D.o(this, "QUEUE_INSERT", new chrome.cast.media.ua([a]), b, c, chrome.cast.media.timeout.v)
    };
    f.tc = function(a, b, c) {
    ...
    f.sc = function(a, b, c) {
        var d = new chrome.cast.media.ya;
        d.repeatMode = a;
        D.o(this, "QUEUE_UPDATE", d, b, c, chrome.cast.media.timeout.v)
    };
    f.qc = function(a, b, c) {
    ...
    f.pc = function(a, b, c) {
        0 > Ka(this, a) || D.o(this, "QUEUE_REMOVE", new chrome.cast.media.wa([a]), b, c, chrome.cast.media.timeout.v)
    };
    f.rc = function(a, b, c) {
    ...
    chrome.cast.media.h.prototype.removeUpdateListener = chrome.cast.media.h.prototype.ca;
    chrome.cast.media.h.prototype.addUpdateListenerWithContext = chrome.cast.media.h.prototype.M;
    chrome.cast.media.h.prototype.addUpdateListener = chrome.cast.media.h.prototype.$;
    chrome.cast.media.h.prototype.getEstimatedLiveSeekableRange = chrome.cast.media.h.prototype.ac;
    chrome.cast.media.h.prototype.getEstimatedBreakClipTime = chrome.cast.media.h.prototype.Zb;
    chrome.cast.media.h.prototype.getEstimatedBreakTime = chrome.cast.media.h.prototype.$b;
    chrome.cast.media.h.prototype.getEstimatedTime = chrome.cast.media.h.prototype.bc;
    chrome.cast.media.h.prototype.supportsCommand = chrome.cast.media.h.prototype.Ec;
    chrome.cast.media.h.prototype.queueMoveItemToNewIndex = chrome.cast.media.h.prototype.mc;
    chrome.cast.media.h.prototype.queueReorderItems = chrome.cast.media.h.prototype.rc;
    chrome.cast.media.h.prototype.queueRemoveItem = chrome.cast.media.h.prototype.pc;
    chrome.cast.media.h.prototype.queueRemoveItems = chrome.cast.media.h.prototype.qc;
    chrome.cast.media.h.prototype.queueSetRepeatMode = chrome.cast.media.h.prototype.sc;
    chrome.cast.media.h.prototype.queueJumpToItem = chrome.cast.media.h.prototype.kc;
    chrome.cast.media.h.prototype.queueNext = chrome.cast.media.h.prototype.nc;
    chrome.cast.media.h.prototype.queuePrev = chrome.cast.media.h.prototype.oc;
    chrome.cast.media.h.prototype.queueUpdateItems = chrome.cast.media.h.prototype.tc;
    chrome.cast.media.h.prototype.queueAppendItem = chrome.cast.media.h.prototype.ic;
    chrome.cast.media.h.prototype.queueInsertItems = chrome.cast.media.h.prototype.jc;
    ...
    chrome.cast.media.h.prototype.pauseWithContext = chrome.cast.media.h.prototype.Ia;
    chrome.cast.media.h.prototype.pause = chrome.cast.media.h.prototype.pause;
    chrome.cast.media.h.prototype.playWithContext = chrome.cast.media.h.prototype.Ja;
    ...
    f.Ta = function(a, b, c) {
        a.Na(new Na(this.sessionId), b, c, chrome.cast.timeout.stopSession)
    };
    f.sendMessage = function(a, b, c, d) {
        this.Pa(D, a, b, c, d)
    };
    f.Pa = function(a, b, c, d, e) {
        a.yc(new La(this.sessionId, b, c), d, e)
    };
    f.$ = function(a) {
        this.M(D, a)
    };
    f.M = function(a, b) {
        a.Xb(this.sessionId, b)
    };
    f.ca = function(a) {
        this.O(D, a)
    };
    f.O = function(a, b) {
        a.xc(this.sessionId, b)
    };
    f.Wb = function(a, b) {
        this.Fa(D, a, b)
    };
    f.Fa = function(a, b, c) {
        a.Ub(this.sessionId, b, c)
    };
    f.Y = function(a) {
        this.Ea(D, a)
    };
    ...
    f.lc = function(a, b, c) {
        a.sessionId = this.sessionId;
        D.Oa(a, "QUEUE_LOAD", b, c)
    };
    x("chrome.cast.Session", chrome.cast.j);
    chrome.cast.j.prototype.queueLoad = chrome.cast.j.prototype.lc;
    chrome.cast.j.prototype.loadMedia = chrome.cast.j.prototype.ec;
    chrome.cast.j.prototype.removeMessageListenerWithContext = chrome.cast.j.prototype.La;
    chrome.cast.j.prototype.removeMessageListener = chrome.cast.j.prototype.wc;
    chrome.cast.j.prototype.removeMediaListenerWithContext = chrome.cast.j.prototype.Ka;
    chrome.cast.j.prototype.removeMediaListener = chrome.cast.j.prototype.aa;
    chrome.cast.j.prototype.addMediaListenerWithContext = chrome.cast.j.prototype.Ea;
    chrome.cast.j.prototype.addMediaListener = chrome.cast.j.prototype.Y;
    chrome.cast.j.prototype.addMessageListenerWithContext = chrome.cast.j.prototype.Fa;
    chrome.cast.j.prototype.addMessageListener = chrome.cast.j.prototype.Wb;
    chrome.cast.j.prototype.removeUpdateListenerWithContext = chrome.cast.j.prototype.O;
    chrome.cast.j.prototype.removeUpdateListener = chrome.cast.j.prototype.ca;
    chrome.cast.j.prototype.addUpdateListenerWithContext = chrome.cast.j.prototype.M;
    chrome.cast.j.prototype.addUpdateListener = chrome.cast.j.prototype.$;
    chrome.cast.j.prototype.sendMessageWithContext = chrome.cast.j.prototype.Pa;
    chrome.cast.j.prototype.sendMessage = chrome.cast.j.prototype.sendMessage;
    chrome.cast.j.prototype.stopWithContext = chrome.cast.j.prototype.Ta;
    chrome.cast.j.prototype.stop = chrome.cast.j.prototype.stop;
    chrome.cast.j.prototype.leave = chrome.cast.j.prototype.dc;
    chrome.cast.j.prototype.getDialAppInfoWithContext = chrome.cast.j.prototype.Ha;
    chrome.cast.j.prototype.getDialAppInfo = chrome.cast.j.prototype.getDialAppInfo;
    chrome.cast.j.prototype.setReceiverMutedWithContext = chrome.cast.j.prototype.Qa;
    chrome.cast.j.prototype.setReceiverMuted = chrome.cast.j.prototype.Bc;
    chrome.cast.j.prototype.setReceiverVolumeLevelWithContext = chrome.cast.j.prototype.Ra;
    chrome.cast.j.prototype.setReceiverVolumeLevel = chrome.cast.j.prototype.Cc;
    var Oa = function(a, b) {
        ...
        fb = function(a, b) {
            ...
            if (a.playerState == chrome.cast.media.F.IDLE && null == a.loadingItemId) a.currentItemId = null, a.loadingItemId = null, a.preloadedItemId = null, a.items = null;
                ...
                for (h = b.next(); !h.done; h = b.next()) {
                    ...
                    l = k.push;
                    var p = void 0,
                        v = new chrome.cast.media.va(h.media);
    ...
    var V = function() {
            ...
            this.I = new J;
            this.J = [];
            this.jb = this.Yb.bind(this);
            this.l = null;
            this.D = 0;
            this.m = null;
            this.ib = new R(this.kb, 200, this);
            this.ja = null
        },
        sb = function(a) {
    ...
    V.prototype.initialize = function(a, b) {
        ...
        a.invisibleSender || (a = new PresentationRequest(X(this)), a.getAvailability().then(function(d) {
            ...
            Y(c, d.connection)
        }, this.ja = (r.navigator || null).presentation.defaultRequest = a, a.reconnect(chrome.cast.Va).then(function(d) {
            Y(c,
                d)
        }, function() {}));
        b && b(void 0)
    ...
    V.prototype.ea = function(a) {
        a.navigator.presentation.defaultRequest = this.ja
    };
    var Y = function(a, b, c) {
        ...
        wb = function(a) {
            var b = Z;
            ub.has(a.type) && b.ka && (b.m ? (a.sessionId = b.m, vb(b, null, a.type, a, function() {}, function() {})) : b.ib.A(X(b, void 0, "urn:x-cast:com.google.cast.media",
                a)))
        };
    ...
    V.prototype.Oa = function(a, b, c, d) {
        var e = this;
        this.D++;
    ...
    f.da = function(a) {
        var b = this;
        (new PresentationRequest(X(this))).reconnect(chrome.cast.sb + a).then(function(c) {
            Y(b, c)
        }, function() {})
    };
    ...
    V.prototype.onMessage = function(a) {
        switch (a.type) {
            ...
            case "v2_message":
                var b = a.message;
                b && "MEDIA_STATUS" == b.type && b.status && (b.status = b.status.map(this.jb))
        }
        ...
        if (b = a.message) switch (a.type) {
            ...
            case "app_message":
                ...
                break;
            case "v2_message":
                "MEDIA_STATUS" == b.type && b.status.forEach(this.Ga.bind(this));
                break;
    ...
    x("chrome.cast.initializeWithContext", chrome.cast.cc);
    chrome.cast.ea = function(a) {
        Z.ea(a)
    };
    x("chrome.cast.setPageContext", chrome.cast.ea);
    chrome.cast.requestSession = function(a, b, c) {
        Z.requestSession(a, b, c)
    };
    x("chrome.cast.requestSession", chrome.cast.requestSession);
    chrome.cast.hc = function(a) {
        wb(new chrome.cast.media.tb(a))
    };
    x("chrome.cast.precache", chrome.cast.hc);
    chrome.cast.da = function(a) {
        chrome.cast.Ma(Z, a)
    };
    x("chrome.cast.requestSessionById", chrome.cast.da);
    chrome.cast.Ma = function(a, b) {
        a.da(b)
    };
    x("chrome.cast.requestSessionByIdWithContext", chrome.cast.Ma);
    ...
    x("chrome.cast.removeReceiverActionListener", chrome.cast.ba);
    chrome.cast.fc = function() {};
    x("chrome.cast.logMessage", chrome.cast.fc);
    chrome.cast.zc = function(a, b) {
        b()
    };
    x("chrome.cast.setCustomReceivers", chrome.cast.zc);
    chrome.cast.Ac = function(a, b) {
        b()
    };
    x("chrome.cast.setReceiverDisplayStatus", chrome.cast.Ac);
    ...
    "complete" == document.readyState ? chrome.cast.fa() : (window.addEventListener("load", chrome.cast.fa, !1), window.addEventListener("DOMContentLoaded", chrome.cast.fa, !1));
}).call(this);